                ...
                if( have_rows('icon_boxs') ):
                    while( have_rows('icon_boxs') ) : the_row();
						...
						<?php if( have_rows('icon_box_1') ): while( have_rows('icon_box_1') ) : the_row(); ?>
                            ...
                            <div class="col-md-2 col-sm-6 col-xs-12 icon-box text-center">
	                    ...
	                    <?php if( have_rows('icon_box_5') ): while( have_rows('icon_box_5') ) : the_row(); ?>

                            <div class="col-md-2 col-sm-6 col-xs-12 icon-box text-center">
                                <i class="fa <?php the_sub_field('icon_5'); ?> fa-3x " aria-hidden="true"></i>
                                <h5 class="text-uppercase"><?php the_sub_field('titre_5') ?></h5>
                                <p><?php the_sub_field('texte_5'); ?></p>
                            </div>
